...
<html lang="en">
  <head>
    ...
    <title>Virtual BulSU - Meneses Announcements</title>
            ...
            <?php
              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $query2 = "SELECT * FROM announcements WHERE college_assignment = '$college' AND campus_assignment = 'Meneses Campus' ORDER BY created_at DESC";
