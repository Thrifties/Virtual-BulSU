...
<html lang="en">
    ...
    <head>
        ...
        <title>Virtual BulSU - Meneses Campus</title>
            ...
            <nav id="navBar" class="navbar navbar-lg navbar-custom">
                <div class="container-fluid">
                    <a class="navbar-brand custom-brand mx-auto d-lg-none" href="VirtualBulsu_Tour_HomePage.php">
                        ...
                        <span class="navbar-title text-wrap text-white">BulSU - Meneses Campus</span>
                    </a>
                    ...
                    <a class="navbar-brand custom-brand mx-auto d-none d-lg-block" href="VirtualBulsu_Tour_HomePage.php">
                        <img src="resources\BSU_Meneses.png" alt="Logo" width="30" height="30" class="d-inline-block align-text-top">
                        <span class="navbar-title text-wrap text-white">Bulacan State University - Meneses Campus</span>
                    </a>
                </div>
            </nav>


            <iframe allow="xr-spatial-tracking; vr; gyroscope; accelerometer; fullscreen; autoplay; xr" scrolling="no" allowfullscreen="true" frameborder="0" src="https://webobook.com/public/6502dafcc602223ba112d1b2,en?ap=true&si=true&sm=false&sp=true&sfr=false&sl=false&sop=false&" allowvr="yes"></iframe>
