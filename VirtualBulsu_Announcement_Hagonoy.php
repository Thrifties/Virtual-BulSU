...
$query = "SELECT college_assignment FROM announcements WHERE campus_assignment = 'Hagonoy Campus' ORDER BY created_at DESC" ;
...
<html lang="en">
  <head>
    ...
    <title>Virtual BulSU - Hagonoy Announcements</title>
...
<body>
    ...
    <div class="container-lg my-3 ">
      <h1 class="text-center text-white" id="heading">Hagonoy Campus News</h1>
            ...
            <?php
              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $query2 = "SELECT * FROM announcements WHERE college_assignment = '$college' AND campus_assignment = 'Hagonoy Campus' ORDER BY created_at DESC";
