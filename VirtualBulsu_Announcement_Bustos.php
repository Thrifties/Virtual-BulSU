...
$query = "SELECT college_assignment FROM announcements WHERE campus_assignment = 'Bustos Campus' ORDER BY created_at DESC";
...
<head>
  ...
  <title>Virtual BulSU - Bustos Announcements</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
  <link rel="stylesheet" href="CSS\VirtualBulsu_Navbar.css" />
  <link rel="icon" href="resources/Virtual BulSU Logo red.png" type="image/x-icon">
            ...
            <?php
              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $query2 = "SELECT * FROM announcements WHERE college_assignment = '$college' AND campus_assignment = 'Bustos Campus' ORDER BY created_at DESC";
