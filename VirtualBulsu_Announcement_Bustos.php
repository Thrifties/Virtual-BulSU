...
<head>
  ...
  <style>
    ...
    body {
      background: url("resources/cover.png");
            ...
            <?php
              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $query2 = "SELECT * FROM announcements WHERE college_assignment = '".$row['college_assignment']."' AND campus_assignment = 'Bustos Campus' ORDER BY created_at DESC";
